...
elif percent >= 70 and <80:
    print ('Student is grade 7')
elif percent >= 60 and <70:
    print ('Student is grade 6')
elif percent >= 50 and <60:
    print ('Student is grade 5')
elif percent >= 40 and <50:
    print ('Student is grade 4')
elif percent >= 30 and <40:
    print ('Student is grade 3')
elif percent >= 20 and <30:
    print ('Student is grade 2')
elif percent >= 10 and <20:
    print ('Student is grade 1')
elif percent >= 0 and <10:
